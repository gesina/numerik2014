...
\begin{Bspe}~
  ...
  \item \index{Splineraumbasis!$S_{2,\Delta}$-Basis} $S_{2,\Delta}$ 
    ...
    \imagemissing{Basis eines $S_{2,\Delta}$-Splines mit Hutfunktion
      (siehe auch \ref{6.2.6} für
      allg. Hutfunktionen)}\label{im6.2.4(2)}
...
\subsectione{Lineare B-Splines}\label{6.2.14}\index{B-Splines!linear}
\index{Splines!linear}
