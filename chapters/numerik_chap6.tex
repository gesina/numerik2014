...
des \textbf{Legendre-Polynoms}\index{Legendre-Polynom} $L_{n+1}$
...
\begin{Satze}\label{6.2.2}\index{abgebrochene Potenz}
  ...
  \begin{gather*}
    \mathcal{B}=
    \left\{
      1,x,\dotsc,x^{k-1},(x-x_1)+^{k-1},\dotsc,(x-x_{n-1})_+^{k-1}
    \right\}
  \end{gather*}
...
\begin{Bspe}~
  ...
  \item \index{Splineraumbasis!$S_{1,\Delta}$-Basis}
    ...
    \begin{image}{\copyright Basis eines $S_{1,\Delta}$-Splines aus stückweise konstanten Elementen}
      \begin{tikzpicture}[>=triangle 45]
        \draw[->,color=black] (0,0) -- (10,0);
