...
Diese können rekursiv, also eindeutig, berechnet werden,
 ...
 \imagemissing{Verfahren von Crout}\\
 
 oder eckweise\\
 \imagemissing{Eckweises Verfahren zur LR-Zerlegung}
  
 oder zeilenweise\\
 \imagemissing{Zeilenweises Verfahren zur LR-Zerlegung}
...
\left\{
 ...
 \end{gather*} 
  ab. \\
  	  ...
  	  \imagemissing{Diagramm zur Rückwärtsanalyse}
